...
#ifndef LFS_TRACE
#ifdef LFS_YES_TRACE
#define LFS_TRACE_(fmt, ...) SEGGER_RTT_printf(0, "%s:%d:trace: " fmt "%s\n", __FILE__, __LINE__, __VA_ARGS__)
...
#ifndef LFS_DEBUG
#ifndef LFS_NO_DEBUG
#define LFS_DEBUG_(fmt, ...) SEGGER_RTT_printf(0, "%s:%d:debug: " fmt "%s\n", __FILE__, __LINE__, __VA_ARGS__)
...
#ifndef LFS_WARN
#ifndef LFS_NO_WARN
#define LFS_WARN_(fmt, ...) SEGGER_RTT_printf(0, "%s:%d:warn: " fmt "%s\n", __FILE__, __LINE__, __VA_ARGS__)
...
#ifndef LFS_ERROR
#ifndef LFS_NO_ERROR
#define LFS_ERROR_(fmt, ...) SEGGER_RTT_printf(0, "%s:%d:error: " fmt "%s\n", __FILE__, __LINE__, __VA_ARGS__)
...
#ifdef LFS_CRC
uint32_t lfs_crc(uint32_t crc, const void *buffer, size_t size){ return LFS_CRC(crc, buffer, size) }
